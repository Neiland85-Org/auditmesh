# Lei Geral de Proteção de Dados (LGPD) Notice - AuditMesh
...
This Lei Geral de Proteção de Dados (LGPD) Notice explains how AuditMesh collects, uses, and shares personal data
about Brazilian residents and describes the rights you have under the LGPD.

Este Aviso da Lei Geral de Proteção de Dados (LGPD) explica como o AuditMesh coleta, usa e compartilha dados pessoais
sobre residentes brasileiros e descreve os direitos que você tem sob a LGPD.
...
## 🌍 **4. Data Sharing and Transfers / Compartilhamento e Transferência de Dados**
...
### 5.7 **Right of Information about Refusal / Direito de Informação sobre Recusa**
...
### 8.1 **Notification Requirements / Requisitos de Notificação**
...
### 11.1 **Privacy Inquiries / Consultas sobre Privacidade**
