# Data Processing Agreement (DPA) Template - AuditMesh
...
This DPA governs the processing of personal data by AuditMesh on behalf of the Data Controller in connection with the provision of audit and compliance services.

Este DPA rige el tratamiento de datos personales por AuditMesh en nombre del Responsable del Tratamiento en relación con la prestación de servicios de auditoría y cumplimiento.

### 2.2 **Duration / Duración**
This DPA shall remain in effect for the duration of the service agreement and shall automatically terminate upon the termination of the main service contract.

Este DPA permanecerá en vigor durante la duración del acuerdo de servicio y se rescindirá automáticamente al terminar el contrato de servicio principal.

## 📊 **3. Nature and Purpose of Processing / Naturaleza y Propósito del Tratamiento**

### 3.1 **Nature of Processing / Naturaleza del Tratamiento**
...
- **Remediation:** Corrective action plans for identified issues
...
Este DPA se regirá e interpretará de acuerdo con las leyes de [Jurisdicción], sin considerar los principios de conflicto de leyes.
